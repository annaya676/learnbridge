                        ...
                        <form id="form-create" action="{{ route('course.updatemodule',$module->id) }}" method="post"  class="needs-validation" novalidate enctype="multipart/form-data">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    ...
                                    <input type="number" name="duration" value="{{ $module->duration }}"   oninput="this.value = this.value.replace(/[^0-9.]/g, '')"  class="form-control py-11 @error('duration') is-invalid @enderror" id="duration" placeholder="Enter Duration">
