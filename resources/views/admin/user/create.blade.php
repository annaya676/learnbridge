                    ...
                    <form id="form-create" action="{{ route('user.store')}}" method="post"  class="needs-validation" novalidate>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 12)" class="form-control py-11 @error('phone') is-invalid @enderror"  minlength="10"  maxlength="12" value="{{ old('phone', '') }}"  name="phone" id="phone" placeholder="Enter Phone">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="date" class="form-control py-11 @error('doj') is-invalid @enderror"  min="{{ date('Y-m-d') }}"  value="{{ old('doj', '') }}"  name="doj" id="doj" placeholder="">
