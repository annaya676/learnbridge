        ...
        <div class="tab-pane fade show active" id="pills-details" role="tabpanel" aria-labelledby="pills-details-tab" tabindex="0">
            <div class="card mt-24">
                <div class="card-header border-bottom">
                    <h4 class="mb-4">Create New Admin</h4>
                </div>
                <div class="card-body">
                    ...
                    <form id="form-create" action="{{ route('admin.store')}}" method="post"  class="needs-validation" novalidate>
                        @csrf
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 12)" class="form-control py-11 @error('phone') is-invalid @enderror" value="{{ old('phone', '') }}"  name="phone" id="phone" placeholder="Enter Phone">
